...
// parseSockAddr resolves given addr to unix.Sockaddr with specified network.
func parseSockAddr(network, addr string) (sAddr unix.Sockaddr, family int, err error) {
